...
## ✨ Motivation
<p>As a newcomer to front-end, I wanted to build something advanced, but still small in scope. For years, I wanted to write ray tracing, 3D scenes, and physics simulation, even going one step further and doing it from scratch, without a library. After getting blessed by the algorithm gods, I found a few projects about black hole renders done in C++, and that became the perfect match. <span style="font-weight: 600;">I go deeper about the development and core concepts here:</span> <a href="./docs/explanation.md">📘 This link does not bite.</a></p>
